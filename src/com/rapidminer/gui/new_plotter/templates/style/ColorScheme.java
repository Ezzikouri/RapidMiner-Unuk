...
public class ColorScheme {
	...
	public ColorScheme(Element element) throws XMLException {
		...
		gradientStartColor = new ColorRGB(XMLTools.getChildElement(element, GRADIENT_START_COLOR_XML_TAG, true));
		gradientEndColor = new ColorRGB(XMLTools.getChildElement(element, GRADIENT_END_COLOR_XML_TAG, true));
		Collection<Element> categoryColors = XMLTools.getChildElements(element, COLORS_XML_TAG);
