/*
 * RapidMiner Copyright (C) 2001-2011 by Rapid-I and the contributors Complete
 * list of developers available at our web site: http://rapid-i.com This program
...
//		panel.print(g);
	...
	private JPanel createLeftSidePanel() {
		...
		//		{
		//			JComboBox attributeSelectionComboBox = new JComboBox(attributeTypes.values());
		//			itemConstraint = new GridBagConstraints();
		//			itemConstraint.gridwidth = GridBagConstraints.REMAINDER;
